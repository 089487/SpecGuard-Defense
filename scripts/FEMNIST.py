...
os.system("python test_agr_pytorch.py --dataset FEMNIST --gpu 1 --net cnn --niter 10000 --nworkers 1200 --nfake 240 --aggregation median --byz_type poisonedfl --sf 8 --local_epoch 1 --server_pc 100")
