...
os.system("python test_agr.py --dataset FEMNIST --gpu -1 --net cnn --niter 10000 --nworkers 120 --nfake 24 --aggregation specguard --byz_type poisonedfl --sf 8 --local_epoch 1")
