...
os.system("python test_agr_pytorch.py --dataset FEMNIST --gpu 1 --net cnn --niter 10000 --nworkers 1200 --nfake 240 --server_pc 10 --aggregation specguard --byz_type poisonedfl --sf 8 --local_epoch 1")
