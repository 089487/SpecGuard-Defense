import os
# Ours
os.system("python test_agr_pytorch.py --dataset cifar10 --gpu 0 --net cnn_cifar --niter 10000 --nworkers 1200 --nfake 240 --aggregation median --byz_type poisonedfl --sf 8 --local_epoch 1 --bias 0.2  --lr 0.03")
